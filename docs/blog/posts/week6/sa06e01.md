...
**Données à utiliser :** Les 3 premières recettes du fichier `data.md`.
...
**Objectif :** Utiliser un outil d’IA (comme Mistral, Copilot, etc.) pour **convertir automatiquement** le contenu du fichier `data.md` en un tableau JavaScript utilisable dans Svelte.
